...
const lotData = [
    ...
    { id: 41, status: 'available', size: '1.9 acres', view: 'Lake View', price: 'Contact for Pricing', description: 'Spectacular views.' },
    ...
    { id: 45, status: 'available', size: '1.6 acres', view: 'Lake View', price: 'Contact for Pricing', description: 'Premium location.' },
    { id: 46, status: 'available', size: '1.1 acres', view: 'Wooded', price: 'Contact for Pricing', description: 'Peaceful homesite.' },
    { id: 47, status: 'available', size: '2.5 acres', view: 'Lake View', price: 'Contact for Pricing', description: 'The largest lake view lot available.' },
